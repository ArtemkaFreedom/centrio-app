module.exports = {
    ...
    settings: {
        ...
        extensionsHint: 'Нативные функции для повышения продуктивности. Доступно в версии PRO.',
    ...
    pro: {
        ...
        extensionsDesc: 'Используйте встроенный AdBlock, переводчик и другие инструменты для продуктивной работы.',
    ...
    extensions: {
        adblock: {
            title: 'AdBlock',
            desc: 'Блокирует рекламу и трекеры во всех мессенджерах.'
        },
        translate: {
            title: 'Google Переводчик',
            desc: 'Быстрый перевод выделенного текста через контекстное меню.'
        },
        grammarly: {
            title: 'Grammarly',
            desc: 'Инструмент для проверки грамматики и улучшения текста.'
        },
        screenshot: {
            title: 'Скриншоты',
            desc: 'Захват экрана и сохранение изображений из мессенджеров.'
        },
        darkmode: {
            title: 'Тёмная тема',
            desc: 'Принудительный тёмный режим для всех сайтов.'
        }
    }
}

    ...
    <section style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.2)', lineHeight: 1.85, columnCount: 2, columnGap: 40, columnRule: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <p style={{ marginBottom: 12 }}>
            Centrio регулярно обновляется: последние версии исправили критические краши при запуске, добавили кастомный выбор акцент-цвета, поддержку всплывающих окон расширений и каталог SEO-плагинов. Автоматическое обновление работает в фоновом режиме — пользователь всегда получает последнюю версию (сейчас v1.9.6).
          </p>

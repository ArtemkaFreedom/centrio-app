          ...
          <div>
              ...
              <div style={{ flex:1 }}>
                ...
                <div style={{ fontSize:13, color:'rgba(255,255,255,0.42)' }}>
                  {isPro
                    ...
                    : 'Базовый доступ · 1 устройство · до 3 мессенджеров'}
                </div>
              </div>
              {!isPro && (
                <button className="btn-primary" onClick={() => { window.location.href = 'https://centrio.me/pricing' }}>
                  Улучшить план <IcoArrow />
                </button>
              )}
            </div>
            ...
            <div style={{ display:'flex', gap:16, marginBottom:32 }}>
              ...
              <div className={`plan-card pro${isPro && !isTeam ? ' current-plan' : ''}`}>
                <div>
                  ...
                  <div style={{ fontSize:30, fontWeight:900, letterSpacing:'-.03em', color:'#fff' }}>299 <span style={{ fontSize:16, fontWeight:400, color:'rgba(255,255,255,0.35)' }}>₽/мес</span></div>
                  <div style={{ fontSize:12, color:'rgba(255,255,255,0.28)', marginTop:4 }}>или 2 499 ₽/год</div>
                ...
                {!isPro && (
                  <button className="btn-primary" style={{ marginTop:'auto' }} onClick={() => { window.location.href = 'https://centrio.me/pricing' }}>
                    Купить Pro <IcoArrow />
                  </button>
                )}
              </div>
            ...
            <div className="glass-card" style={{ padding:'22px 26px' }}>
              ...
              <div style={{ display:'flex', gap:12, flexWrap:'wrap' }}>
                {[
                  { label:'ЮKassa', sub:'Карты РФ, СБП' },
                  { label:'Криптовалюта', sub:'BTC, ETH, USDT' },
                  { label:'Карты EU/US', sub:'Скоро' },
                ].map(m => (
                  <div key={m.label} style={{ background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.08)', borderRadius:12, padding:'12px 18px' }}>
              ...
              <div style={{ marginTop:16, fontSize:12, color:'rgba(255,255,255,0.25)' }}>
                Подключение оплаты в разработке. Для активации Pro обратитесь в поддержку.
              </div>
            </div>
          </div>
        )}

...
const MessengerSvgs: Record<string, ReactElement> = {
  discord:      <svg viewBox="0 0 24 24" fill="white" width="26" height="26"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-2.4.0.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-2.4.0.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 2.4.0 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 2.4.0.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-2.4.0.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.2.4.0 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.2.4.0 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.2.4.0.2.4.0a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-2.4.0.077.077 0 0 0-.041.107c.2.4.0 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-2.4.0.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-2.4.0-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-2.4.0-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/></svg>,
  vk:           <svg viewBox="0 0 24 24" fill="white" width="26" height="26"><path d="M15.684 0H8.316C1.592 0 0 1.592 0 8.316v7.368C0 22.408 1.592 24 8.316 24h7.368C22.408 24 24 22.408 24 15.684V8.316C24 1.592 22.391 0 15.684 0zm3.692 17.123h-1.744c-.66 0-.864-.525-2.05-1.727-1.033-1-1.49-1.135-1.744-1.135-.356 0-.458.102-.458.593v1.575c0 .424-.135.678-2.4.0-1.846 0-3.896-1.118-5.335-3.202C4.624 10.857 4.03 8.57 4.03 8.096c0-.254.102-.491.593-.491h1.744c.44 0 .2.4.0.677.863 2.49 2.303 4.675 2.896 2.4.0 0 .322-.102.322-.66V9.721c-.068-1.186-.695-1.287-.695-1.71 0-.203.17-.407.44-.407h2.744c.373 0 .2.4.0.643v3.473c0 .2.4.0.2.4.0 0 .407-.136.813-.542 1.253-1.406 2.151-3.574 2.151-2.4.0-.254.322-.491.763-.491h1.744c.525 0 .2.4.0.643-.22 1.017-2.354 4.031-2.354 4.031-.186.305-.254.44 0 .2.4.0.796.779 1.203 2.4.0.847 1.32 1.558 1.473 2.4.0.49-.085.744-.576.744z"/></svg>,
  ...
  instagram:    <svg viewBox="0 0 24 24" fill="white" width="24" height="24"><path d="M12 2.163c3.204 0 2.4.0 2.4.0 2.4.0 4.771 1.691 4.919 2.4.0 2.4.0 2.4.0 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-2.4.0-2.4.0-2.4.0-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-2.4.0-2.4.0-2.4.0-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-2.4.0-2.4.0-2.4.0-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 2.4.0 2.4.0 2.4.0 4.358 2.618 6.78 6.98 6.98 2.4.0 2.4.0 2.4.0 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-2.4.0-2.4.0-2.4.0-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-2.4.0-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>,
  viber:        <svg viewBox="0 0 24 24" fill="white" width="24" height="24"><path d="M11.4 0C2.4.0 2.12 2.35 1.1 7.28c-.47 2.27-.41 2.4.0 7 .88 3.77 4.23 6.63 7.98 2.4.0.14 2.4.0 2.4.0H11c.48 0 .97-.03 1.45-.08l2.93 2.93c.2.4.0.2.4.0.27 0 .5-.22.5-.5v-3.48c2.7-1.17 4.66-3.52 5.28-2.4.0-2.4.0-5.15-.2-7.3C20.04 2.67 16.36-.02 11.4 0z"/></svg>,
  signal:       <svg viewBox="0 0 24 24" fill="white" width="24" height="24"><path d="M11.999 0a12 12 0 1 0 0 24 12 12 0 0 0 0-24zm.643 3.13a8.845 8.845 0 0 1 5.238 2.222l-1.09 1.09a7.32 7.32 0 0 0-4.148-1.77V3.13zm-1.285 0v1.542a7.32 7.32 0 0 0-4.149 1.77L6.12 5.353a8.845 8.845 0 0 1 5.237-2.222zm6.614 2.908a8.845 8.845 0 0 1 2.222 5.237h-1.542a7.32 7.32 0 0 0-1.77-4.148l1.09-1.089zm-2.4.0l1.09 1.09a7.32 7.32 0 0 0-1.77 4.147H1.807a8.845 8.845 0 0 1 2.221-5.237zm14.614 6.604c-.088 2.028-.9 3.87-2.188 5.27l-1.088-1.088a7.33 7.33 0 0 0 1.734-4.182h1.542zm-15.685 0h1.542a7.33 7.33 0 0 0 1.734 4.182l-1.089 1.089a8.845 8.845 0 0 1-2.187-5.271zm13.315 6.456a8.845 8.845 0 0 1-5.27 2.188v-1.542a7.33 7.33 0 0 0 4.182-1.734l1.088 1.088zm-11.706-.001l1.088-1.088a7.33 7.33 0 0 0 4.182 1.734v1.542a8.845 8.845 0 0 1-5.27-2.188z"/></svg>,
  notion:       <svg viewBox="0 0 24 24" fill="white" width="22" height="22"><path d="M4.459 4.208c.746.606 2.4.0 2.4.0l13.215-.793c.28 0 .047-.28-.046-.326L17.86 1.968c-.42-.326-.981-.7-2.055-.607L3.01 2.295c-.466.046-.56.28-.374.466zm.793 3.08v13.904c0 .747.373 1.027 2.4.0l14.523-.84c.841-.047.934-.56.934-1.167V6.354c0-.606-.233-.933-.748-.887l-2.4.0c-.56.047-.746.327-.746.934zm2.4.0c.093.42 0 .84-.42.888l-.7.14v10.264c-.608.327-2.4.0-2.4.0-.748 0-.935-.234-1.495-.933l-4.577-7.186v6.952L12.21 19s0 .84-2.4.0l-2.4.0c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.822 9.76c-.094-.42.14-2.4.0-1.073l3.456-.233 4.764 7.279v-6.44l-1.215-.14c-.093-.514.28-.887.747-.933z"/></svg>,
  trello:       <svg viewBox="0 0 24 24" fill="white" width="24" height="24"><path d="M21 0H3C1.343 0 0 1.343 0 3v18c0 1.656 1.343 3 3 3h18c1.656 0 3-1.344 3-3V3c0-1.657-1.344-3-3-3zM10.44 18.18c0 .795-.645 1.44-1.44 1.44H4.56c-.795 0-1.44-.645-1.44-1.44V4.56c0-.795.645-1.44 1.44-1.44H9c.795 0 2.4.0 1.44 1.44v13.62zm10.44-7.2c0 .795-.645 1.44-1.44 1.44H15c-.795 0-1.44-.645-1.44-1.44V4.56c0-.795.645-1.44 1.44-1.44h4.44c.795 0 2.4.0 1.44 1.44v6.42z"/></svg>,
  telegram_web: <svg viewBox="0 0 24 24" fill="white" width="24" height="24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.248l-2.04 9.607c-.145.658-.537.818-2.4.0l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 2.4.0.903.614z"/></svg>,
}
...
const OsIcons = {
  ...
  macos:   <svg viewBox="0 0 24 24" fill="currentColor" width="30" height="30"><path d="M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.4.0-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 2.09-.987 3.935-.987 1.831 0 2.4.0 2.4.0 1.637-.026 2.676-1.48 3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.039-.013-3.182-1.221-3.22-4.857-.026-3.04 2.48-4.494 2.597-4.559-1.429-2.09-3.623-2.324-4.39-2.376-2-.156-3.675 1.09-4.61 1.09zM15.53 3.83c.843-1.012 1.4-2.427 1.245-3.83-2.4.0-2.4.0-3.532 1.818-.78.896-1.454 2.338-1.273 3.714 2.4.0 2.715-.688 3.559-1.701"/></svg>,
  linux:   <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 16 16"><path d="M2.273 9.53a2.273 2.273 0 1 0 0-4.546 2.273 2.273 0 0 0 0 4.547Zm9.467-4.984a2.273 2.273 0 1 0 0-4.546 2.273 2.273 0 0 0 0 4.546M7.4 13.108a5.54 5.54 0 0 1-3.775-2.88 3.27 3.27 0 0 1-2.4.0 7.4 7.4 0 0 0 5.328 4.465c.53.113 2.4.0 2.4.0a3.25 3.25 0 0 1-.666-1.9 6 6 0 0 1-.557-.091m3.828 2.285a2.273 2.273 0 1 0 0-4.546 2.273 2.273 0 0 0 0 4.546m3.163-3.108a7.44 7.44 0 0 0 .373-8.726 3.3 3.3 0 0 1-1.278 1.498 5.57 5.57 0 0 1-.183 5.535 3.26 3.26 0 0 1 1.088 1.693M2.098 3.998a3.3 3.3 0 0 1 2.4.0 5.54 5.54 0 0 1 4.464-2.388c.037-.67.277-2.4.0-1.843a7.47 7.47 0 0 0-7.051 3.745"/></svg>,
}
      ...
      <div style={{ display: 'flex', height: 340 }}>
        ...
        <div style={{ width: 48, background: 'rgba(0,0,0,.35)', borderRight: '1px solid rgba(255,255,255,.04)', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '6px 0', gap: 4, flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 3, alignItems: 'center', paddingTop: 4, borderTop: '1px solid rgba(255,255,255,.05)', width: '100%', flexShrink: 0 }}>
            {[
              <svg key="s" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.32)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-2.4.0l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 2.4.0H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>,
                ...
                <motion.div
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 5 }}>
                    <div style={{ width: 24, height: 24, borderRadius: 7, background: 'linear-gradient(135deg,#5865F2,#4752c4)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                      {MessengerSvgs.discord && <svg viewBox="0 0 24 24" fill="white" width="13" height="13"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-2.4.0.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-2.4.0.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 2.4.0 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 2.4.0.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-2.4.0.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.2.4.0 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.2.4.0 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.2.4.0.2.4.0a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-2.4.0.077.077 0 0 0-.041.107c.2.4.0 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-2.4.0.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03z"/></svg>}
                    </div>

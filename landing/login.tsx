  ...
  return (
    <>
      ...
      <div style={{ minHeight:'100vh', display:'flex', background:'#060a14', color:'#fff' }}>
        ...
        <div style={{ position:'fixed', bottom:-100, right:'20%', width:320, height:320, borderRadius:'50%', background:'radial-gradient(circle,rgba(99,102,241,0.07) 0%,transparent 70%)', pointerEvents:'none' }} />
        ...
        <div style={{
          ...
          <div>
            ...
            <h1 style={{ fontSize:28, fontWeight:800, letterSpacing:'-.035em', lineHeight:1.2, marginBottom:14 }}>
              Все мессенджеры<br />в одном окне
            </h1>
            <p style={{ fontSize:14, color:'rgba(255,255,255,0.45)', lineHeight:1.65, marginBottom:40 }}>
              Telegram, WhatsApp, Discord, Slack и другие — в едином приложении с облачной синхронизацией.
            </p>

            <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
              {[
                { text:'Единая панель уведомлений', icon:<><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" stroke="#60a5fa" strokeWidth="1.8"/><path d="M13.73 21a2 2 0 0 1-3.46 0" stroke="#60a5fa" strokeWidth="1.8"/></> },
                { text:'Облачная синхронизация данных', icon:<><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" stroke="#60a5fa" strokeWidth="1.8" strokeLinejoin="round"/></> },
                { text:'Горячие клавиши и быстрый переход', icon:<><rect x="2" y="7" width="20" height="14" rx="2" stroke="#60a5fa" strokeWidth="1.8"/><path d="M16 2l-4 5-4-5" stroke="#60a5fa" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></> },
              ].map((f, i) => (
        ...
        <div style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', padding:'40px 24px' }}>
          <div style={{ width:'100%', maxWidth:440, animation:'fadeUp .4s ease' }}>
            ...
            <div style={{ marginBottom:32 }}>
              <h2 style={{ fontSize:24, fontWeight:800, letterSpacing:'-.03em', marginBottom:6 }}>Добро пожаловать</h2>
              <p style={{ fontSize:14, color:'rgba(255,255,255,0.4)' }}>Войдите в свой аккаунт Centrio</p>
            </div>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:14, marginBottom:24 }}>
              ...
              <span style={{ fontSize:12, color:'rgba(255,255,255,0.28)', whiteSpace:'nowrap' }}>или войдите с паролем</span>
              <div style={{ flex:1, height:1, background:'rgba(255,255,255,0.07)' }} />
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ display:'flex', flexDirection:'column', gap:12, marginBottom:18 }}>
                ...
                <div style={{ position:'relative' }}>
                  <input className="auth-input" type={showPass ? 'text' : 'password'} placeholder="Пароль" value={password} onChange={e => setPassword(e.target.value)} required autoComplete="current-password" style={{ paddingRight:44 }} />
            ...
            <p style={{ textAlign:'center', marginTop:20, fontSize:14, color:'rgba(255,255,255,0.35)' }}>
              Нет аккаунта?{' '}
              <Link href="/auth/register" style={{ color:'#60a5fa', textDecoration:'none', fontWeight:600 }}>
                Зарегистрироваться
              </Link>
            </p>
          </div>

...
const WIN_DOWNLOAD = 'https://download.centrio.me/Centrio%20Setup%201.7.9.exe';
      ...
      <div style={{ minHeight: '100vh', background: '#080810', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 24px 80px' }}>
          ...
          <section style={{ textAlign: 'center' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: 13, marginTop: 12 }}>{t.blog_cta_platforms ?? 'Версия 1.7.9 · Бесплатно · Windows · macOS · Linux'}</p>
          </section>
        </div>
      </div>
      <SiteFooter />

...
export const metadata: Metadata = {
  title: 'Centrio vs Franz: какой агрегатор мессенджеров выбрать в 2026?',
  description: 'Сравнение Centrio и Franz — двух агрегаторов мессенджеров. Franz платный и тяжёлый, Centrio — бесплатный, быстрый и со встроенным VPN. Подробный анализ для 2026 года.',
  alternates: { canonical: 'https://centrio.me/blog/vs-franz' },
  openGraph: {
    title: 'Centrio vs Franz 2026: полное сравнение агрегаторов',
    description: 'Franz vs Centrio — сравниваем цены ($14.99 vs 199 ₽), производительность, VPN и функции. Что выбрать в 2026?',
    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#080810', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 24px 80px' }}>
          ...
          <section style={{ marginBottom: 56 }}>
            <h2 style={{ fontSize: 26, fontWeight: 700, marginBottom: 24, color: '#e2e8f0' }}>Почему Centrio лучше Franz</h2>
              ...
              {[
                ...
                <div key={m.metric} style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12, padding: '16px', textAlign: 'center' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                    ...
                    <div>
                      <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', marginBottom: 4 }}>Franz</div>
                      <div style={{ fontWeight: 700, color: '#f87171' }}>{m.franz}</div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <section style={{ textAlign: 'center' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', marginBottom: 28 }}>Скачайте сейчас — 5 сервисов навсегда бесплатно, без ввода карты.</p>
            <a
              href={WIN_DOWNLOAD}
              style={{
